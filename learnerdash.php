...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./learnerdash.css">
         ...
         <main class="wrapper">
             <header class="dashboard">
                ...
                <svg width="50px" height="35px" viewBox="0 0 50 50" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
                 ...
                 <a href="./learnerdash.php" style="text-decoration: none;" class="home_title"> Welcome, <?php echo $_SESSION['username']; ?>!</a>
                 </div>
                 ...
                 <div class="request_btns">
                     ...
                     <a href="#" id="pay_req"><abbrev title="Current Marks">57 Mrks</abbrev></a>
                     <a href="#" id="loan_advance"><abbrev title="Grading">M.E.</abbrev></a>
                 </div>
             </header>
              ...
              <!--Profile contents-->
                 <div id="profile" class="holdwrap holder profile_settings">
                  ...
                  <form method="post" action="profileUp.php" class="prof_pic_box">
                    <abbrev id="show_user_name" title="Denis Muthee King'ori"><a href="#">
                    <?php
...
if(isset($_SESSION['username'])) {
    ...
    if ($getImgResult->num_rows > 0) {
        ...
        echo '<img class="dashImg" src="' . $imgPath . '" alt="Profile Image">';
    } else {
...
?>
                  ...
                  <div class="user-info">
                    ...
                    <div class="data-box name_of">
                      ...
                      <p class="name-of"><?php echo $_SESSION['username']; ?></p>
                    ...
                    <div class="workForm data-box">
                      <p class="work_title">Registration Number</p>
                  ...
                  <!--CLASS-->
                    ...
                    <div class="phone data-box">
                      <p class="phone_user">Fee balance</p>
                    ...
                    <div class="mail data-box">
                      <p class="email_title">Date of Birth</p>
                    ...
                    <div class="id data-box">
                      <div class="starter">
                      <span class="emp_id_passport">Parent Phone:</span>
                    ...
                    <div class="lang_of data-box">
                      ...
                      <span class="selected_lang selected_value">English</span>
                    ...
                    <div class="gender_select data-box">
                      <div class="starter">
                        <span class="selected_gender selected_value">Status:</span>
                        <span class="selected_gender selected_value">Present</span>
                 ...
                 <div id="jobs" class="holdwrap job_holder job_settings">
                    ...
                    <div class="job_hist_table">
                      <table class="job_table">
                        ...
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td><input type="text" class="table_input" id="subjCode"></td>
                            <td><input type="text" class="table_input" id="subjectName"></td>
                            <td></td>
                            <td></td>
                            <td></td>
                          </tr>
                  ...
                  <div class="skills_section boxer">
                    ...
                    <div class="list_of_skills">
                      <p class="subj_name shome">Home</p>&centerdot;
...
<hr class="stuHr">
                  ...
                  <div class="tabsubjSection">
                    <div class="subj_btns_holders">
                      <a href="#" class="subj_btn_title" id="subj_main_btn" onclick="opensubjSec(event, 'subjAnnments')">Announcements</a>
                      <a href="#" class="subj_btn_title" onclick="opensubjSec(event, 'subjNotes')">Notes</a>
                      <a href="#" class="subj_btn_title" onclick="opensubjSec(event, 'subjAssignments')">Assignments</a>
                      <a href="#" class="subj_btn_title" onclick="opensubjSec(event, 'subjExams')">Exams</a>
                      <a href="#" class="subj_btn_title" onclick="opensubjSec(event, 'subjDiscussion')">Discussion</a>
                    </div>
                    ...
                    <div class="subj_content_wrapper">
                      ...
                      <div class="subj-content_four subj_content" id="subjExams">
                        <h3 class="subj_content_header">Exams</h3>
                        <hr class="stuHr">
                        <div class="subj_cont_info">
